...
open class AKSideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    @IBInspectable public var contentViewInPortraitOffsetCenterX: CGFloat = 30.0 //custom
    ...
    func commonInit() {
        ...
        self.menuViewControllerTransformation = CGAffineTransform(scaleX: 1.7, y: 1.7) //menu setting
        ...
        self.contentViewInPortraitOffsetCenterX = 50 //side menu custom
        self.contentViewScaleValue = 1 //side menu custom
    }
    ...
    func showLeftMenuViewController() {
        ...
        UIView.animate(withDuration: self.animationDuration, animations: {
            ...
            let centerX = UIWindow.isLandscape ?
    ...
    func showRightMenuViewController() {
        ...
        UIView.animate(withDuration: self.animationDuration, animations: {
            ...
            self.contentViewContainer.center = CGPoint(x: (UIWindow.isLandscape ? -self.contentViewInLandscapeOffsetCenterX : -self.contentViewInPortraitOffsetCenterX),
                                                       y: self.contentViewContainer.center.y)
    ...
    func hideMenuViewControllerAnimated(_ animated: Bool) {
        ...
        let visibleMenuViewController = (rightMenuVisible ? self.rightMenuViewController : self.leftMenuViewController)
